...
public class CheckHotels extends JFrame implements Runnable
{
    ...
    public void run()
    {
        String[] text = new String[]{"JW Marriott Hotel","Madarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classsio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Hote","River View Hotel"};
